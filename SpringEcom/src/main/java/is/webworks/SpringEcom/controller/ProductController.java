package is.webworks.SpringEcom.controller;

import is.webworks.SpringEcom.Product;
import is.webworks.SpringEcom.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> getProductPyId(@PathVariable int id){
